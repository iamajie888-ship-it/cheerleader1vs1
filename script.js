...
let scores = {};
let history = {};
let currentStage = 'stage1';  // stage1, stage2(top20), stage3(top10)
let round = 1;
...
function updateDisplay() {
    let roundNum, matchesLeft = currentRoundMatches.length - matchIndex;
    let stageTitle = '';
    ...
    if (currentStage === 'stage1') {
        ...
        roundNum = round - 6;  // 7,8,9 → 1,2,3
        stageTitle = `🎯 前20強 第${roundNum}輪`;
    } else {
        roundNum = round - 9;  // 10,11 → 1,2
